...
[A-Za-z]+ ([\-]+ [A-Za-z0-9]+)* {System.out.println("TOK_IDENTIFIER"); toString("TOK_IDENTIFIER");tablaSimbolos.put(yytext(),"TOK_IDENTIFIER"); return new Symbol(sym.TOK_IDENTIFIER,yyline+1, yycolumn+1,yytext()); }
